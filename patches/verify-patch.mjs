...
const checks = [
  ...
  ["html: 底部来源链接(第18轮,第20轮沉底+英文)", '#wt-src-links { margin: 22px 8px 6px 0; text-align: right;', "html"],
  ["html: 来源链接英文三连(第20轮)", '>Upstream</a> · <a href="https://github.com/rzfff/wtstats-mirror" target="_blank" rel="noopener noreferrer">Source</a> · <a href="/wtstats/LICENSE">License</a>', "html"],
  ["html: 来源链接不再跟随视窗(第20轮)", null, "html-neg:#wt-src-links \\{ position: fixed"],
